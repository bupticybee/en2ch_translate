...
file_middle = 'middleresult/segmented_train_seg_by_word.txt'
pickle_middle = 'middleresult/segmented_train_seg_by_char.pkl'
zh_vocab = 'middleresult/zh_vocab.txt'
en_vocab = 'middleresult/en_vocab.txt'
